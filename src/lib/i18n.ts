...
export const t: Record<Locale, Record<string, string>> = {
  da: {
    ...
    download: 'Køb nu',
    ground: 'Bane',
    heroDivisionAlt: 'AB-spillere på lægterne i de nye udebanetrøjer',
    heroDivisionCta: 'Hele historien',
    heroDivisionHeadline: 'AB vender tilbage til Betinia Liga',
  ...
  en: {
    ...
    download: 'Buy now',
    ground: 'Ground',
    heroDivisionAlt: 'AB players in the stands wearing the new away kits',
    heroDivisionCta: 'Full Story',
    heroDivisionHeadline: 'AB returns to 1. Division',
    heroJoinAlt: 'Join AB',
